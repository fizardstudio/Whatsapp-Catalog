        ...
        <div className="md:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <button
              ...
              className={`text-left p-4 rounded-2xl flex items-center justify-between transition-all border-2 ${selectedPackage === "coba"
            ...
            <button
              ...
              className={`text-left p-4 rounded-2xl flex items-center justify-between relative overflow-hidden transition-all border-2 ${selectedPackage === "laris"
          ...
          <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-4 border border-blue-100 dark:border-blue-800/50">
            ...
            <div className="bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700 mb-4 flex items-center justify-between">
              <div>
                ...
                <div className="font-mono text-sm font-bold text-slate-900 dark:text-white tracking-widest mt-0.5">740 519 2241</div>
                <div className="text-xs text-slate-500">a.n. Mochamad Firman</div>
              </div>
              <button
            ...
            <p className="text-xs text-blue-800 dark:text-blue-300">
              3. Setelah transfer, klik tombol <strong>"Top Up Koin Sekarang"</strong> di atas untuk mengirim bukti transfer via WhatsApp ke Admin.
            </p>
          </div>
        </div>
      </div>
            ...
            {transactions.map((tx) => (
              <div key={tx.id} className="p-4 sm:px-6 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${tx.amount > 0
                ...
                <div className={`font-bold ${tx.amount > 0 ? "text-green-600 dark:text-green-400" : "text-slate-900 dark:text-white"
                  }`}>
